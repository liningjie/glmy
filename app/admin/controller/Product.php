...
class Product extends Base
{
    ...
    public function index(){
        ...
        return TableBuilder::getInstance()
            ...
            ->addTopButtons(['submit' => [
                'title'       => '移动式光谱仪',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=29',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '激光清洗机',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=28',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '手持式光谱仪',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=27',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '液相色谱仪',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=26',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '台式X荧光光谱仪',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=25',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '红外碳硫分析仪',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=24',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '直读光谱分析仪',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Product/index.html?cate_id=23',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->fetch();
