    ...
    public function index(){
        ...
        return TableBuilder::getInstance()
            ...
            ->addTopButtons(['submit' => [
                ...
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Article/index.html?cate_id=31',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '企业新闻',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Article/index.html?cate_id=30',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '解决方案',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Article/index.html?cate_id=34',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '问题解决',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Article/index.html?cate_id=33',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->addTopButtons(['submit' => [
                'title'       => '学术交流',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Article/index.html?cate_id=32',
                'target'      => '_self',
                'onclick'     => ''
                ]])
             ->addTopButtons(['submit' => [
                'title'       => '客户案例',
                'class'       => 'btn btn-danger',
                'href'        => 'http://cxglmy.wxjoi.com/junyi/Article/index.html?cate_id=15',
                'target'      => '_self',
                'onclick'     => ''
                ]])
            ->fetch();
