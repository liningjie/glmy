(function ($) {
  ...
  LM.prototype = {
    menu: function () {
      ...
      var LI_HEIGHT =
        _this.find(".f2 li").height() +
        parseInt(_this.find(".f2 li").css("padding-top")) +
        parseInt(_this.find(".f2 li").css("padding-bottom"));
